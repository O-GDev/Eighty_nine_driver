...
const EmailScreen = ({navigation}) => {
  return (
    <SafeAreaView>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('ResturantName')} style={{alignSelf:'center',backgroundColor:'#1AA303',width:'85%',padding:5,borderRadius:100,height:50,justifyContent:'center'}}><Text style={{color:'white',fontWeight:'400',alignSelf:'center',fontSize:20,fontFamily:'Inconsolata_600SemiBold'}}>Next</Text></TouchableOpacity>
      </View>
      </View>
       </View>
    </SafeAreaView>
